...
const Hero = () => {
  ...
  return (
    <div className='h-full w-full bg-white overflow-auto custom-scrollbar flex flex-col gap-5 pb-[30px]'>
      <h1 className='font-italiana text-[20px] md:text-left lg:text-[30px] lg:text-center transition'>
        Creative Sparks for Infinite Futures.
      </h1>
      ...
      <div className='flex flex-col gap-20'>
        {projectsData.map((project) => (
          <button
            key={project.id}
            className='w-full h-[58vw] md:h-[38vw] xl:h-[30vw] flex flex-col gap-2 group cursor-pointer'
