...
export const updatesData = [
  ...
  {
    date: "2025/11/01",
    title: "CalaSense: Development Completed!",
    description: "After four months of continuous development, model training, and field data collection, we have successfully completed our Calamansi Leaf Disease Detection mobile application. The project involved training our YOLOv5 model, gathering and testing real sample leaves, and utilizing a pre-annotated dataset from Roboflow to ensure accurate detection performance. Through iterative testing, optimization, and system integration, we were able to refine both the model and the application interface. With the system fully developed and validated, we are now prepared to present and defend our capstone thesis.",
    collaborators: ["Nicklaus Ling, Ram Nacar, Jose Idpan"],
  },
  {
    date: "2025/08/13",
