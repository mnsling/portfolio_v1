...
const Navbar = () => {
  ...
  return (
    <>
      {/* Fixed Navbar */}
      <div className="fixed top-0 left-0 w-full z-30 bg-white border-b border-black">
      ...
      <div
        className={`fixed inset-0 z-20 bg-white px-[15px] pt-[80px] transition ${isOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
          }`}
      >
