        ...
        <div className="relative w-full min-w-[70%] min-h-[50%] flex justify-between z-50">
            ...
            {doneTyping && (
                <div className='w-[40%] flex flex-col justify-between items-end'>
                    ...
                    <div className='flex w-full items-center pb-16 animate-wipeRight'>
                        <div className='w-full h-1 bg-[#d61723]' />
                        <h1 className='w-[50%] text-[2vw] text-[#d61723] text-right leading-[2vw] font-bold tracking-tighter'>Est. 2025</h1>
                    </div>
                </div>
            )}
        </div>
